...
class Game_win_exception extends Exception{
    public Game_win_exception(String msg){
        super(msg);
    }
}
class Snake_exception extends Exception{
    public Snake_exception(String msg){
        super(msg);
    }
}
class Vulture_exception extends Exception{
    public Vulture_exception(String msg){
        super(msg);
    }
}
class Cricket_exception extends Exception{
...
class White_exception extends Exception{
        ...
        try{
            ...
            while(current_tile_number!=getLength_of_track()){
                ...
                if(getRoll()>=10*getLength_of_track()){
                    // if(count>=2){
                    //     System.out.println("Error detected ... Reconfiguring... to a possible track length");
                    //     setRoll(0);
                    //     tiles = new ArrayList<Tile>();
                    //     setTotal_cricket(0);
                    //     setTotal_snake(0);
                    ...
                    //     setTotal_vulture(0);
                    //     setLength_of_track(getLength_of_track()/10);
                    //     create_track();
                    //     game_initial_loop();
                    //     count=0;    
                    // }
